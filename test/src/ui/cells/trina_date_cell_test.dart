...
void main() {
  ...
  group('Selection with Keyboard ', () {
    testWidgets(
      'when initial date is 2020-01-01, pressing up arrow and enter should select 2019-12-31',
      (tester) async {
        await buildCellAndEdit(
          tester,
          initialCellValue: '2020-01-01',
    ...
    testWidgets(
      'When initial date is 2020-1-30, pressing up arrow and enter should select 2020-1-23',
      (tester) async {
        await buildCellAndEdit(
          tester,
          initialCellValue: '2020-01-30',
        );
        await openPopup(tester);
        ...
        expect(cell.value, '2020-01-23');
      },
    );

    testWidgets(
      'when initial date is 2020-1-31, pressing right arrow and enter should select 2020-2-1',
      (tester) async {
        await buildCellAndEdit(
          tester,
