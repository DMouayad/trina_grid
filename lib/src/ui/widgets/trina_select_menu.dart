...
class _TrinaSelectMenuState extends State<TrinaSelectMenu> {
  ...
  void _removeFilter(TrinaSelectMenuFilter filter) {
    filterValueControllers[filter]?.removeListener(_onFilterChanged);
  ...
  void dispose() {
    ...
    activeFiltersNotifier.removeListener(_onFilterChanged);
    ...
    searchFieldController.removeListener(_onFilterChanged);
