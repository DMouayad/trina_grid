...
class TrinaDateTimeCellState
  ...
  bool isDateTimeInRange(DateTime? initialDateTime) {
    return initialDateTime != null &&
        (_column.endDate != null
            ? initialDateTime.isBefore(_column.endDate!) ||
                initialDateTime.isAtSameMomentAs(_column.endDate!)
            : true) &&
        (_column.startDate != null
            ? initialDateTime.isAfter(_column.startDate!) ||
                initialDateTime.isAtSameMomentAs(_column.startDate!)
            : true);
  }
    ...
    return LayoutBuilder(
      builder: (context, parentConstraints) {
        ...
        final popupConstraints = showAsVertical
            ...
            : const BoxConstraints(maxWidth: 550, maxHeight: 340);
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              TrinaTimePicker(
                                autoFocusMode:
                                    TrinaTimePickerAutoFocusMode.none,
